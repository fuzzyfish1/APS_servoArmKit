 ...
 * Author: Zain Ali
 *
 * APS ReadySetCode Servo Kit Unit 1 Starter Code: Servo.h Library functions
 *
...
void setup() {
	...
	// an example for base servo, now repeat for all the servos
...
void loop() {
	...
	// go to pos 1, for all servos

	delay(2000);

	// go to pos 2, for all servos
